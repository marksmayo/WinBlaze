...
pub use model::{
    aggregate_directory_records, detect_file_lineage_change, diff_file_records,
    DirectoryAggregation, DirectoryId, DirectoryRecord, FileAttributes, FileChangeKind,
